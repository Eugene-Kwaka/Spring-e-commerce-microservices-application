...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<CustomerErrorResponse> handleMethodArgumentException(MethodArgumentNotValidException e){
        ...
        */
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(new CustomerErrorResponse(errors));
    }
    ...
    */
    ...
    public ResponseEntity<CustomerErrorResponse> handleConstraintViolation(ConstraintViolationException e) {
